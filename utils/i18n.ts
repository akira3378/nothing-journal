...
const baseTranslations = {
  zh: {
    ...
    create_account: '注册账户',
    register_title: '开始记录',
    register_subtitle: '创建账户后即可发布旅行记录。',
    register_nickname: '昵称',
    register_success: '注册成功，正在进入旅行记录。',
    back_to_login: '返回登录',
    account_exists: '账户已存在，请直接登录。',
    registration_failed: '注册失败，请稍后重试。',
    profile_creation_failed: '作者资料创建失败。',
  ...
  en: {
    ...
    register_title: 'START WRITING',
    register_subtitle: 'Create an account to publish travel notes.',
    register_nickname: 'Nickname',
    register_success: 'Registration complete. Opening your journal.',
    back_to_login: 'Back to login',
    account_exists: 'This account already exists. Please log in.',
    registration_failed: 'Registration failed. Please try again.',
    profile_creation_failed: 'Could not create the author profile.',
...
const translations = {
  ...
  ja: {
    ...
    register_title: '旅を記録する',
    register_subtitle: 'アカウントを作成して旅行記録を公開できます。',
    register_nickname: 'ニックネーム',
    register_success: '登録が完了しました。旅行記録を開きます。',
    back_to_login: 'ログインに戻る',
    account_exists: 'このアカウントはすでに存在します。ログインしてください。',
    registration_failed: '登録に失敗しました。もう一度お試しください。',
    profile_creation_failed: '作者プロフィールを作成できませんでした。',
