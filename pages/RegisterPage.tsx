                ...
                <div className="bg-white dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800 p-8 rounded-sm backdrop-blur-sm shadow-sm dark:shadow-none transition-colors">
                    {error && (
                        <motion.div
                            ...
                            className="mb-6 p-3 bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm rounded-sm flex items-center"
                        >
                            ...
                            >
                                <form onSubmit={handleVerifyOtp} className="space-y-6">
                                    ...
                                    <div className="flex gap-4">
                                        <button type="button" onClick={() => setStep('enter_email')} className="px-4 py-4 bg-zinc-200 dark:bg-zinc-800 text-black dark:text-white text-sm font-bold rounded-sm disabled:opacity-50 hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors">
                                            BACK
                                        </button>
                                        <motion.button
                                            whileHover={{ scale: 1.02 }}
                                            ...
                                            <AnimatePresence>
                                                {tags.map(tag => (
                                                    <motion.span
                                                        ...
                                                        className="inline-flex items-center px-2.5 py-1 rounded-sm text-xs font-bold bg-black dark:bg-white text-white dark:text-black border border-black dark:border-white"
                                                    >
                                                        {tag}
